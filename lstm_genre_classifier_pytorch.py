...
def main():
    ...
    for epoch in range(num_epochs):
        ...
        # Learning rate decay
        # if epoch+1 == int(0.2*num_epochs):
        #     optimizer.param_groups[0]['lr'] = 0.1 * learning_rate
        # if epoch+1 == int(0.5*num_epochs):
    ...
    if savefig:
        plt.savefig('graph_train_loss.png')
    plt.show()
    ...
    if savefig:
        plt.savefig('graph_train_accuracy.png')
    plt.show()
    ...
    if savefig:
        plt.savefig('graph_val_loss.png')
    plt.show()
    ...
    if savefig:
        plt.savefig('graph_val_accuracy.png')
    plt.show()
