...
def main():
    ...
    scheduler = optim.lr_scheduler.ReduceLROnPlateau(optimizer, 'min', cooldown=10 )
        ...
        if (epoch+1) % 10 == 0:
            ...
            with torch.no_grad():
                ...
                for i in range(num_dev_batches):
                    ...
                    scheduler.step(val_loss) # use reduce Lr on plateau
                ...
                print(
                    "Epoch:  %d | --------------- | Val Loss %.4f | Val Accuracy: %.2f | New Lr:"
                    % (
                        epoch+1,
    ...
    if savefig:
        plt.savefig('./result/ReduceLROnPlateau/graph_lr.png')
    plt.show()
    ...
    if savefig:
        plt.savefig('./result/ReduceLROnPlateau/graph_train_loss.png')
    plt.show()
    ...
    if savefig:
        plt.savefig('./result/ReduceLROnPlateau/graph_train_accuracy.png')
    plt.show()
    ...
    if savefig:
        plt.savefig('./result/ReduceLROnPlateau/graph_val_loss.png')
    plt.show()
    ...
    if savefig:
        plt.savefig('./result/ReduceLROnPlateau/graph_val_accuracy.png')
    plt.show()
